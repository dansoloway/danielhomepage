...
jQuery(document).ready(function($) {
		...
		if (link.length>0) {
			...
			if ($(".header-page-dark").length>0) {
				document.getElementById("logo").src="images/logo_dark_header_" + tp_stylesheet + ".png";
			} else {
				if ($("#logo").length>0) {
					document.getElementById("logo").src="images/logo_" + tp_stylesheet + ".png";
				};
		...
		$('.style-switcher .styleChange li').on('click',function(){
			if (link.length>0) {
				...
				if ($(".header-page-dark").length>0) {
					document.getElementById("logo").src="images/logo_dark_header_" + tp_stylesheet_no_cookie + ".png";
				} else {
					if ($("#logo").length>0) {
						document.getElementById("logo").src="images/logo_" + tp_stylesheet_no_cookie + ".png";
					};
					if ($("#logo-footer").length>0) {
